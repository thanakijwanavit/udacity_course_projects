...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    with open(dogfile, "r") as infile:
        ...
        while line != "":
            ...
            line_list = line.translate(translation_table).split(",")
            #print(repr(line.translate(translation_table).split(",")))
    ...
    for key in results_dic:
        ...
        if results_dic[key][0] in dognames_dic.keys():
            ...
            if set(results_dic[key][1].split(","))& set(dognames_dic.keys()):
...
adjust_results4_isadog({"chihuahua":['hello','chihuahua'],"sample2":['lowchen','petit basset griffon vendeen']}, 'dognames.txt')