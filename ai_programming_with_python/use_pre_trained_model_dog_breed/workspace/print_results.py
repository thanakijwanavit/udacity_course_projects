...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print("{:20}: {:.1f}".format('% Match (this includes both dogs and not-a dog)', results_stats_dic['pct_matches']))
                
        
     # IF print_incorrect_dogs == True AND there were images incorrectly 
    # classified as dogs or vice versa - print out these cases
    if (print_incorrect_dogs and 
        ( (results_stats_dic['n_correct_dogs'] + results_stats_dic['n_correct_non-dog'])
        ...
        for key in results_dic:
            ...
            if(results_dic[key][3]!=results_dic[key][4]):
                print(key,'\nPet Image Label is a Dog - Classified as NOT-A-DOG' if results_dic[key][3] == 1 else 'Pet Image Label is NOT-a-Dog - Classified as a-DOG')
...
#    print("the function is running and print_incorrect_breed value is: %r , correct dogs is %d , correct breed is %d "% (print_incorrect_breed,results_stats_dic['n_correct_dogs'],results_stats_dic['n_correct_breed']))
